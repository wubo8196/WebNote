...
<body>
	<form id="class_add" method="post" action="${pageContext.request.contextPath }/noteBook_updateOneNoteBook.action"
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<input name="bookName" lay-verify="required" autocomplete="off"
					value="${noteBook.bookName }" class="layui-input" type="text">
			</div>
		</div>
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<input name="bookDesc" lay-verify="required" autocomplete="off"
					value="${noteBook.bookDesc }"  class="layui-input" type="text">
			</div>
		</div>
		<div class="layui-form-item">
